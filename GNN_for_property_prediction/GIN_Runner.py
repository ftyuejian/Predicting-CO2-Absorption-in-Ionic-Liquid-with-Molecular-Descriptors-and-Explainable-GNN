...
class Runner(object):
    ...
    def __init__(self,args):
        ...
        if args['load_history_model'] == True:
            ...
            # state_dict_opt = torch.load('pretrained_model/GIN_300/best_optimizer_para.pth')
            ...
            # state_dict_sch = torch.load('pretrained_model/GIN_300/best_scheduler_para.pth')
...
if __name__ == '__main__':
    ...
    plot(train_true, train_pred,test_true,test_pred,'GIN')
